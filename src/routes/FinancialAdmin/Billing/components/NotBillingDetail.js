...
export default class NotBillingDetail extends Component {
    ...
    return (
      ...
      >
        <FinancialOrderDetail
          orderId={Number(this.state.orderInfo.GUID) || Number(this.state.orderInfo.DDID)}
          orderType={String(this.state.orderInfo.DDLX || 'unknown')}
          financialType={Constant.SAAS.financial.BILLING}
        />
      </StandardDataGrid>
    )
  }
